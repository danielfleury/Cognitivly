...
import 'businessassociate_model.dart';
export 'businessassociate_model.dart';

class BusinessassociateWidget extends StatefulWidget {
  const BusinessassociateWidget({super.key});

  @override
  _BusinessassociateWidgetState createState() =>
      _BusinessassociateWidgetState();
}

class _BusinessassociateWidgetState extends State<BusinessassociateWidget>
    with TickerProviderStateMixin {
  late BusinessassociateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessassociateModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'businessassociate'});
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'BUSINESSASSOCIATE_I_AGREE_BTN_ON_TAP');
