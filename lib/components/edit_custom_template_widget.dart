...
import 'edit_custom_template_model.dart';
export 'edit_custom_template_model.dart';

class EditCustomTemplateWidget extends StatefulWidget {
  const EditCustomTemplateWidget({
    super.key,
    required this.templatedoc,
  });

  final NoteTemplatesRecord? templatedoc;

  @override
  _EditCustomTemplateWidgetState createState() =>
      _EditCustomTemplateWidgetState();
}

class _EditCustomTemplateWidgetState extends State<EditCustomTemplateWidget> {
  late EditCustomTemplateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCustomTemplateModel());

    _model.templateTitleController ??=
        TextEditingController(text: widget.templatedoc?.templateTitle);
    _model.templateTitleFocusNode ??= FocusNode();

    _model.templateDescriptionController ??=
        TextEditingController(text: widget.templatedoc?.templateDescription);
    _model.templateDescriptionFocusNode ??= FocusNode();

    _model.templateExampleController ??=
        TextEditingController(text: widget.templatedoc?.templateExample);
              ...
              child: Row(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDIT_CUSTOM_TEMPLATE_DONE_BTN_ON_TAP');
                              ...
                              await widget.templatedoc!.reference
                                  .update(createNoteTemplatesRecordData(
                                templateTitle:
                                    _model.templateTitleController.text,
                                templateDescription:
                                    _model.templateDescriptionController.text,
                                templateExample:
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'EDIT_CUSTOM_TEMPLATE_Icon_53ez8ffi_ON_TA');
