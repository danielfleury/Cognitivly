...
import '/components/rate_note_widget.dart';
...
import 'soap_note_popup_model.dart';
export 'soap_note_popup_model.dart';

class SoapNotePopupWidget extends StatefulWidget {
  const SoapNotePopupWidget({
    super.key,
  ...
  @override
  _SoapNotePopupWidgetState createState() => _SoapNotePopupWidgetState();
}

class _SoapNotePopupWidgetState extends State<SoapNotePopupWidget> {
  late SoapNotePopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SoapNotePopupModel());
    ...
    _model.noteregenerationController ??= TextEditingController();
    _model.noteregenerationFocusNode ??= FocusNode();
                  ...
                  child: Row(
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SOAP_NOTE_POPUP_COMP_CopySOAP_ON_TAP');
                                        logFirebaseEvent(
                                            'CopySOAP_copy_to_clipboard');
                                        await Clipboard.setData(ClipboardData(
                                            text:
                                                _model.rawnoteController.text));
                                        logFirebaseEvent(
                                            'CopySOAP_show_snack_bar');
                                    ...
                                    Expanded(
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            5.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'SOAP note generation is currently in beta and may not be precise for nuanced clinical descriptions',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Manrope',
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'SOAP_NOTE_POPUP_Image_5zgurtg9_ON_TAP');
                                                              logFirebaseEvent(
                                      ...
                                      children: [
                                        Form(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .noteregenerationController,
                                              focusNode: _model
                                                  .noteregenerationFocusNode,
                                              autofocus: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                labelStyle:
                                                ...
                                                hintText:
                                                    'Regenerate this note from feedback...',
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                              ...
                                              validator: _model
                                                  .noteregenerationControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                        Stack(
                                          children: [
                                            if (FFAppState().noteregenerating ==
                                                false)
                                              InkWell(
                                                splashColor: Colors.transparent,
                                                focusColor: Colors.transparent,
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SOAP_NOTE_POPUP_Image_ge01m8fr_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Image_validate_form');
                                                  if (_model.formKey
                                                              .currentState ==
                                                  ...
                                                  logFirebaseEvent(
                                                      'Image_backend_call');
                                                  _model.regeneratednote =
                                                      await SOAPNoteRegenerationCall
                                                          .call(
                                                    therapynote: functions
                                                        .replaceLineBreaks(functions
                                                  ...
                                                  await containerSessionNotesRecord
                                                      .reference
                                                      .update(
                                                          createSessionNotesRecordData(
                                                    aiSoapNote:
                                                        SOAPNoteRegenerationCall
                                                            .regeneratedsoapnote(
                                                      (_model.regeneratednote
                                                              ?.jsonBody ??
                                                          ''),
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'SOAP_NOTE_POPUP_COMP_SAVE_BTN_ON_TAP');
                                    logFirebaseEvent('Button_backend_call');

                                    await widget.sessiondocument!.reference
                                        .update(createSessionNotesRecordData(
                                      aiSoapNote: _model.rawnoteController.text,
                                    ));
                                        ...
                                        return Padding(
                                          ...
                                          child: SizedBox(
                                            height: MediaQuery.sizeOf(context)
                                                    .height *
                                                1.0,
                                            child: RateNoteWidget(
                                              sessionnotepass:
                                                  widget.sessiondocument!,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'SOAP_NOTE_POPUP_Icon_p572xqh6_ON_TAP');
