...
import 'birp_note_popup_model.dart';
export 'birp_note_popup_model.dart';

class BirpNotePopupWidget extends StatefulWidget {
  const BirpNotePopupWidget({
    super.key,
  ...
  @override
  _BirpNotePopupWidgetState createState() => _BirpNotePopupWidgetState();
}

class _BirpNotePopupWidgetState extends State<BirpNotePopupWidget> {
  late BirpNotePopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BirpNotePopupModel());
                  ...
                  child: Row(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'BIRP_NOTE_POPUP_COMP_CopyBIRP_ON_TAP');
                                      logFirebaseEvent(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          5.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        'BIRP note generation is currently in beta and may not be precise for nuanced clinical descriptions',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Manrope',
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'BIRP_NOTE_POPUP_Image_skzrftuf_ON_TAP');
                                                              logFirebaseEvent(
                                        ...
                                        children: [
                                          if (FFAppState().noteregenerating ==
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'BIRP_NOTE_POPUP_Image_vwbpzox2_ON_TAP');
                                                logFirebaseEvent(
                                                    'Image_validate_form');
                                                if (_model.formKey
                                                            .currentState ==
                                                ...
                                                setState(() {
                                                  FFAppState()
                                                      .noteregenerating = true;
                                                });
                                                logFirebaseEvent(
                                                    'Image_backend_call');
                                                _model.regeneratednote =
                                                    await BIRPNoteRegenerationCall
                                                        .call(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'BIRP_NOTE_POPUP_COMP_DONE_BTN_ON_TAP');
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'BIRP_NOTE_POPUP_Icon_fpi8l0vq_ON_TAP');
