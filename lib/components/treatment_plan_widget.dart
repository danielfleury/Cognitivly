...
export 'treatment_plan_model.dart';
...
class TreatmentPlanWidget extends StatefulWidget {
  ...
  @override
  _TreatmentPlanWidgetState createState() => _TreatmentPlanWidgetState();
}

class _TreatmentPlanWidgetState extends State<TreatmentPlanWidget> {
  late TreatmentPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TreatmentPlanModel());
                  ...
                  child: Row(
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TREATMENT_PLAN_COMP_CopySOAP_ON_TAP');
                                        logFirebaseEvent(
                                    ...
                                    Expanded(
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            5.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'Treatment plan generation is currently in beta and may not be precise for nuanced clinical descriptions',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Manrope',
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'TREATMENT_PLAN_Image_s2p1f5jg_ON_TAP');
                                                              logFirebaseEvent(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    'Regenerate this plan from feedback...',
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                          ...
                                          children: [
                                            if (FFAppState().noteregenerating ==
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'TREATMENT_PLAN_Image_hvw5x1zb_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Image_validate_form');
                                                  if (_model.formKey
                                                              .currentState ==
                                                  ...
                                                  _model.regeneratednote =
                                                      await TreatmentPlanRegenerationCall
                                                          .call(
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'TREATMENT_PLAN_COMP_SAVE_BTN_ON_TAP');
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'TREATMENT_PLAN_COMP_Icon_utkblvth_ON_TAP');
